...
import { AdminGuard } from "@/widgets/guards";
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-forest-light">
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 text-sage-light hover:bg-forest-light hover:text-white rounded-lg transition-colors"
              >
